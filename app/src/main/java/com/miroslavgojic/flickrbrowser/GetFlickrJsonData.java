...
// For accessing Flickr.
// Extends functionality from GetRawData
// First we download raw data(GetRawData class), then we processing as JSON data
public class GetFlickrJsonData extends GetRawData {
    ...
    private void processResult(){
        ...
        try {
            ...
            for(int i = 0; i < itemsArray.length(); i++){
                ...
                //String mLink, String mTags, String mImage, String mTitle, String mAuthor, String mAuthorId
                Photo photoObject = new Photo(link, tags, photoUrl, title, author, authorId);
    ...
    public class DownloadJsonData extends DownloadRawData {
        ...
        protected String doInBackground(String... params) {
            String[] par = { mDestinationUri.toString() }; // creating object with one element
